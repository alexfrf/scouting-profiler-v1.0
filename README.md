...
In 2022, it will be a decade since the premiere of one of the works that have marked world sport, as far as the illustration of data-based methods is concerned. **Moneyball** was established forever as a concept that, as with the term "Big Data", does not shy away from clichés at the same time that it is coined as a word to describe any strategy based on the treatment and analysis of applied data. on a practical level in the sports environment. The feat of the Oackland A's at the beginning of the century in the MLB and its fantastic signing on the big screen, with Brad Pitt as the protagonist, undoubtedly marked a milestone in the democratization of a new way of understanding the game, moving away from clichés and judgments perceptive and focused on maximizing resources from what was, at that time, a utopia: trusting everything to data, processed, moreover, by people who did not belong to the sector, such as physicists, engineers or economists.

The disruption, thus, was not immediate and has encountered all kinds of obstacles. While in the US basketball, American football and professional baseball have been installed for a decade in this type of new "dictatorship" (their critics, the most romantic, do not hesitate to say that the game is now much less unpredictable and imaginative - they are not without reason , but we are talking about sectors whose agents are authentic media and financial ocean liners, today what matters is to compete, maximize limited resources and win-). In Europe, the data boom in the beautiful game occurred in the middle of the last decade in the United Kingdom, Germany and the Scandinavian countries. The sector is still immature and with a huge margin to explore, both at a cognitive and technological level.

In this context, the examples that we find on the application of these methods to the recruitment of football players in our continent are very specific, but also extreme. Matthew Benham, ex-ward of another pioneer such as Brighton owner Tony Bloom, became obsessed with developing predictive betting models that ended up making him a millionaire. Those same models are now in production at the club of his childhood, Brentford, which he has led with this philosophy to the Premier League. Even today, already in the elite and with budgets higher than practically any club in Europe can handle, they continue to apply their models. The seed arose with a premise: to stop looking at the traditional metrics of goals, passes, wins or losses, and develop new metrics and indicators -his are the very famous Expected Goals- that signaled the progress of the team according to other factors. This allowed Brentford to spot undervalued players going under the radar and build a business model around them to record record profits. Exactly like Billy Beane in *Moneyball*.

Such capital gains, and the discovery of today's world-class players, such as Said Benrahma, Ollie Watkins or Ivan Toney, would never have occurred without the large-scale exploitation of data and the use of algorithms.

![image.png](/Documentacion/image.png)

Further democratizing Benham's methods -with more modest algorithms and source data-, the objective of this project is to generate a model that outlines the characteristics of the players of the five major European leagues according to advanced metrics and, segmenting the game model of the teams, to be able to associate, to each club, the footballers who, for each position on the field, are closest to their game model. The purpose is to add the variant of the team's style of play -their own and the others-, measuring and quantifying it to be able to find those players that are closest, based on advanced metrics, to the numbers of the team that we are analyzing. Those footballers will be the ones that, potentially, best suit the needs for which said team goes to the market, since they will be pieces that will require a shorter adaptation process and will know similar game mechanisms, since they will come from sets that, tactically and in their way of playing, they show similarities.

There are, available for public consultation, a large number of models that offer the possibility of finding the players that are closest to the metrics of another in particular -in this same project you will be able to find one, in fact, that we will combine with the analysis of the teams to build our final model. These analyzes can be highly valid at club management level when, in a market context, it is necessary to replace a player who has left the club or whose performance has dropped. However, these situations occur relatively infrequently in the real world, the most common being the need to find a correction to a current weakness in the market or the improvement of a specific position.

The added value of this model lies, then, in its ability to add the factor of the characteristics of the teams when assessing which is the most suitable footballer in which to invest in the market. This would help, as I explained above, in the recruitment process to reduce the group of players who are candidates to end up being a signing, limiting the error in the sports field and ensuring that aspects such as tactical adaptation are easier.

Models such as the one proposed are not so clearly applicable in clubs of great magnitude. Real Madrid or Manchester City do not need analytical models to discover where the value is, since their level attracts -and they can afford at an economic level- the greatest available talent. Not so the majority of clubs, who know that their potential market is enormous and, furthermore, have the handicap that a possible mistake penalizes much more, given that financial resources are much more limited.
